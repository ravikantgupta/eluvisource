...
function setApplicationLogoBanner_preview(response) {
    ...
    var storeLogo = "<a href='javascript:void(0);'><img style='width:120px;' src="+logo_data.image[0].mofluid_image_value+" onerror ='this.src=\'images/" + config.data[0].logo + "\'' alt='" + config.data[0].logo + "' class='logo_icon'/></a>";
