   ...
   // $("#Cate_slide").append('<div class="new_cate_panel_div_main" id="mofluid_home"  onclick=\"Page.redirect("index.html", "slide", "down");\">'+locale.message.button["home"]+'</div>');
    ...
    for(var key in data) {
        ...
        if (data.hasOwnProperty(key)) {
            ...
            alert('<div class="new_cate_panel_div" id="new_category_id_'+data[key].id+'" onclick="new_sub_cat('+data[key].id+', 0,\''+data[key].name+'\')">'+data[key].name+'</div><div class="new_sub_cate_panel_div" style="display:none;" id='+data[key].id+'></div>');
